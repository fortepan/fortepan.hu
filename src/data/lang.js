module.exports = {
  hu: {
    ...
    back: "Vissza",
    bookmarks: "Listák",
    bookmark: "Listához adás",
    bookmark_new: "Új lista",
    bookmark_choose: "Lista kiválasztása",
    bookmark_new_name: "Új lista neve",
    bookmark_signin_alert: "A saját lista funkció használatához kérjük, hogy előbb lépjen be.",
    cancel: "Mégsem",
    city: "Város",
  ...
  en: {
    ...
    back: "Back",
    bookmark: "Bookmark",
    bookmark_signin_alert: "Please sign in first before bookmarking this photo.",
    cancel: "Cancel",
    city: "City",
