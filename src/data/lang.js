module.exports = {
  hu: {
    ...
    list_edit_public_label: "Az url ismeretében bárki által megtekinthető",
    list_edit_private_label: "A lista nem tekinthető meg mások számára",
  ...
  en: {
    ...
    list_edit_public_label: "Anyone with the url can view",
    list_edit_private_label: "No one else can view",
    load_more: "Load more",
    location: "Location",
    login: "Login",
    menu: "Menu",
